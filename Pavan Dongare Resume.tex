...
% Hyperlink setup: colored text links, no boxes
\hypersetup{
    colorlinks=true,
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{1.8cm}|X|}
\hline
\textbf{Product:} & \textbf{B2B marketplace SaaS} \\ & Government \textbf{workflow apps} for \href{https://www.mahapolice.gov.in/}{\textcolor{blue!70!black}{Maharashtra Police}} \\ \hline
\textbf{Scope:} & \begin{itemize}[leftmargin=*,nosep]
